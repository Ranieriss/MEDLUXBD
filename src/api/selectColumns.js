export const EQUIPAMENTO_SELECT_COLUMNS = 'id,codigo,nome,modelo,tipo,status,created_at,updated_at';

export const OBRA_SELECT_COLUMNS = 'id,codigo,nome,local,status,created_at,updated_at';
